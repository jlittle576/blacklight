...
class GUI(QtGui.QMainWindow):
    ...
    def setup_toolBar(self):
        ...
        openAction = QtGui.QAction("Open XML", self)
        #QtGui.QAction(QtGui.QIcon(runPath("open.png")), "Open", self)
...
def main():
    ...
    ui.statusBar.showMessage(os.getcwd())
